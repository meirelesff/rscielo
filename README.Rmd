...
`rscielo` provides functions to scrape bibliometric information from scientific articles hosted on the [Scientific Electronic Library Online Platform (Scielo.br)](http://www.scielo.br/). The retrieved data includes journal's citation counts; article's contents, footnotes, bibliographic references; and many other common bibliometrics. The package also offers functions to summarize the scrapped data.


### Installing

To install the latest stable release from [CRAN](http://cran.r-project.org/), use:
