...
With the `rScielo`, it is possible to scrape several publication and citation metrics from a journal hosted on [Scielo](http://www.scielo.br/):
...
To visualize the citations granted and received aggregated by year, just use the `plot()` function:
